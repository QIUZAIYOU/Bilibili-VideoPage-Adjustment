  ...
  const main = {
    ...
    registerMenuCommand() {
      GM_registerMenuCommand("设置", () => {
        ...
        $("#Top-Offset").change((e) => {
          utils.setValue("offset_top", Number(e.target.value));
        });
