...
// @updateURL         https://raw.githubusercontent.com/QIUZAIYOU/Bilibili-VideoPage-Adjustment-NEXT/main/BilibiliVideoPageAdjustment-NEXT.js?token=GHSAT0AAAAAACADBMRCNU3NVKWFNS5X2MFOZASNT4A
// @installURL        https://raw.githubusercontent.com/QIUZAIYOU/Bilibili-VideoPage-Adjustment-NEXT/main/BilibiliVideoPageAdjustment-NEXT.js?token=GHSAT0AAAAAACADBMRCNU3NVKWFNS5X2MFOZASNT4A
// @downloadURL       https://raw.githubusercontent.com/QIUZAIYOU/Bilibili-VideoPage-Adjustment-NEXT/main/BilibiliVideoPageAdjustment-NEXT.js?token=GHSAT0AAAAAACADBMRCNU3NVKWFNS5X2MFOZASNT4A
                ...
                <div id="playerAdjustment" style="font-size: 1em;">
                  ...
                  <div class="player-adjustment-setting-label screen-mod" style="display: flex;align-items: center;justify-content: space-between;"> 播放器默认模式 <div style="width: 215px;display: flex;align-items: center;justify-content: space-between;">
                      <label class="player-adjustment-setting-label" style="padding-top:0!important;">
                        <input type="radio" name="Screen-Mod" value="close" ${
                          getValue('selected_screen_mode') === 'close'
        ? 'checked'
        : ''
        }>关闭</label>
                      <label class="player-adjustment-setting-label" style="padding-top:0!important;">
